...
All architectures are compatible with TensorFlow only.

Pre-trained weights can be automatically loaded upon instantiation (`weights='imagenet'` argument in model constructor for all image models). Weights are automatically downloaded, and cached locally in `~/.keras/models/`.
